...
=======
	...
	Inhalt...
\\S	- unser Ziel ist es eine leicht bedienbare App zu entwickeln, bei der sich die Leute wie in Pokemon Go auf einer Karte sehen und zu ihrer Umgebung (Sehenswürdigkeiten) Fragen beantworten.
\\
\\M	- unser Ziel ist es im ersten Jahr einen Umsatz von 50.000€ zu erzielen
\\
\\A	- unser Ziel ist es auch, dass die möglichste viele Leute anspricht.
\\
\\R	- wir sind uns sicher, dass die App einschlagen wird wie eine Bombe
\\
\\T	- ende des Schuljahres sollten wir mit der Umsetzung unseres Projekts fertig sein
...
\begin{itemize}
	...
	\item Projektrisiken feststellen und lösen
	\item Projektchancen suchen und darstellen
	\item Einflussnahme der Stakeholder
	\item Projektteam und Kunden
	\item Erfolgung und Lizenz für das Projekt
	
\end{itemize}
\subsection{Risikoanalyse}
\begin{itemize}
	\item Risikomatrix
	\item Identifikation der Risiken
	\item Risikobewertung
	\item Risikoportfolio erstellen
	\item Risikocontrolling
	\item Kosten
	\item Qualität
	\item Zeit
	\item Prozess und Prozessablauf
\end{itemize}
...
\begin{itemize}
	...
	\item Produktfunktion: 
		  Die App ist mit Google Maps verbunden, du läufst rum wie in PokemonGo nur in unsereren App ist es anderst. Du beantwortest verschiedene Fragen zu der Umgebung, daher ist diese App mehr für Schüler oder Menschen die ihr Wissen auffrischen wollen! 
	\item SOLL-Zustand
...
\begin{itemize}
	...
	\begin{itemize}
		\item Die App muss den genauen Standort des Nutzers vermittlen
		\item Die App muss den genauen Standort der verschiedenen Brunnen vermitteln
		\item Die App muss die Suchfunktion des jeweiligen Brunnen genau ausgeben, auf der Karte anzeigen und eine geeignete Route dafür ermessen 
		\item Für die App muss das GPS eingeschaltet sein
		\item Für die App muss eine Internetverbindung bestehen
	\end{itemize}
	\item KANN-Anforderungen
	\begin{itemize}
	\item Die App hat eine Sprachfunktion
	\item Die App kann den Brunnen in mehreren Sprachen ausgeben
	\item Die App verfügt über eine Premiumfunktion (keine Werbung, VR-Funktion,...)
	\end{itemize}
\end{itemize}
